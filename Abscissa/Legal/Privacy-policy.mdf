...
description: "Ensures your data remains private."
icon: "file-contract"
iconType: "solid"
---
...
<AccordionGroup>
	...
	<Accordion title="Application">
		Refers to Abscissa, the software program provided by the Company.
	</Accordion>
	<Accordion title="Company">
		Refers to <Tooltip tip='Also referred to as "the Company", "We", "Us" or "Our" in this Agreement.'>Abscissa</Tooltip>.
	</Accordion>
	...
	<Accordion title="Service Provider">
		Any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.
	</Accordion>
	<Accordion title="Third-party Social Media Service">
	...
	<Accordion title="Usage Data">
		Refers to <Tooltip tip="e.g. the duration of a page visit.">data collected automatically</Tooltip>, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).		
	</Accordion>
	<Accordion title="Website">
		Refers to Abscissa, accessible from [https://abscissa.eu](https://abscissa.eu).
	</Accordion>
	<Accordion title="You">
