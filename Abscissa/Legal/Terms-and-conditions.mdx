...
description: "Know what you sign up for."
icon: "book-section"
iconType: "solid"
---
...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Abscissa
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Abscissa.
...
- __Website__ refers to Abscissa, accessible from [https://abscissa.eu](https://abscissa.eu)
