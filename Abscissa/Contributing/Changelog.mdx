...
<Steps>
    ...
    <Step stepNumber="4">
        <AccordionGroup>
            ...
            <Accordion title="v4.13.1">
                ## Major
                1. Added feature dashboard with endpoints.
                ## Minor
                1. Added virtual environments in order not to break system packages.
                1. Moved validation exclusively to server temporarily with *Pydantic.*
                1. Improved *SEO* with *HTML* tags.
                1. Added service worker.
                1. Added a wrapper for views in `ß`.
                1. Added `$Fluid` background.
                1. Added copy *LaTeX* button as a public component named `$Small`.
                1. Added navbar.
                1. Improved suspense handling.
                1. Added `manifest.json`.
                ## Patch
                1. Fixed spelling in `README.md`.
                1. Fixed database procedures.
                1. Added script to move files to dev server.
                1. Fixed *DiceBear* app module.
                1. Added preconnect to `esm.sh`.
                1. Updated dependencies versions.
                1. Removed `#Main` and now the app renders directly in `document.body`.
                1. Modified `$.redirect` function to allow for external URLs.
                1. Fixed *LaTeX* styling.
                1. Divided `ß` components into public and private.
                1. Refactored `$Silk` background.
                1. Changed all `ß.react.ReactElement` for `ß.react.ReactNode`.
                1. Improved default *Mathsys* code.
                1. Fixed `robots.txt`.
                1. Fixed redirect loop in *Nginx* configuration and 
                1. Added content type *XML* for the sitemap in `abscissa.conf`.
            </Accordion>
            <Accordion title="v4.15.0">
                ## Major
                1. Set up *Android* app with *Bubblewrap.*
                1. Moved feature management to *Featurebase.*
                ## Minor
                1. Set up virtual environment.
                ## Patch
                1. Fixed typos in `README.md`.
                1. Namespaced *Python* imports.
                1. Improved *Python* types and signatures.
                1. Improved `æ.handler` processing.
                1. Added exports with `__all__` to `__init__.py`.
                1. Renamed extensions for clarity.
                1. Added ordering to database procedures.
                1. Improved procedure signatures.
                1. Improved database procedure calling by using *Pydantic* validation.
                1. Updated *Mathsys* to use `mathsys.v1`.
                1. Removed `modulator` function from `$`.
                1. Improved `$Main` component selection.
                1. Added `$Solid` background.
                1. Improved manifest with a logo.
                1. Added `/manifest.webmanifest` *URL.*
            </Accordion>
            <Accordion title="v4.15.62">
                ## Minor
                1. Removed *Android* tools.
                1. Merged `$` and `ß`.
                1. Enhanced playground component so it now allows for paper texture and optional copy button.
                ## Patch
                1. Removed error codes from `SUG.py`.
                1. Added `æ.typing.Self` to *Python* classes.
                1. Updated *Mathsys* to the development version.
                1. Removed `public/base` and moved files to bare `public/`.
                1. Added a thin border to the navbar.
                1. Improved default code in playground editor.
            </Accordion>
        </AccordionGroup>
    </Step>
</Steps>